package com.fangcloud.noah.service.util.ip;
...
import com.fangcloud.noah.service.util.FileUtils;

/**
 * ip归属地信息 qqzeng-ip-utf8.dat数据库 购买于淘宝网店铺 https://item.taobao.com/item.htm?spm=a230r.1.14.7.PbmdvG&id=17199927955&ns=1&abbucket=18#detail
 * 由于每月会递增更新需要定期替换新的数据包，具体信息可以参见http://qqzeng.com/(手机号归宿地数据库也是购买于此)
...
public class IpSearch {
    ...
    public IpSearch() {
        ...
        String webRootPath = System.getProperty("risk.ws.root");

        String ipDataPath = webRootPath + "qqzeng-ip-utf8.dat";

//        String testPath = "/home/chenke/IdeaProjects/hlj-risk/branches/20170116_risk_ws_chenke/risk-ws/src/main/resources/ipdata/qqzeng-ip-utf8.dat";
        try {

            data = FileUtils.getContent(ipDataPath);
