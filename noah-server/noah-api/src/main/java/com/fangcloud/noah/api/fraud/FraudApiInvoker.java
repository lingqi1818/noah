package com.fangcloud.noah.api.fraud;
//package com.helijia.framework.risk.fraud;
//
...
//
//    public FraudApiInvoker(String apiUrl) {
//        this.apiUrl = apiUrl;
//        // 设置连接池
...
//        String apiUrl = "https://apitest.fraudmetrix.cn/riskService";
//        FraudApiResponse apiResp = new FraudApiInvoker(apiUrl).invoke(params);
