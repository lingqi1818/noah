...
/**
 * 类CompositeCharConverter.java的实现描述：TODO 类实现描述
 *
 * @author guolin.zhuanggl 2008-7-19 下午02:05:33
 */
...
//        String pckName = CharNormalization.class.getPackage().getName();
        file =  "data/" + file;
        InputStream istream = CharNormalization.class.getClassLoader().getResourceAsStream(file);
        if (istream == null) {
