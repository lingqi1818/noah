(function ( $ ) {
    ...
    $.fn.BootSideMenu = function( options ) {
        ...
        this.addClass("container sidebarnew");

        if(side=="left"){
            this.addClass("sidebarnew-left");
        }else if(side=="right"){
            this.addClass("sidebarnew-right");
        }else{
            this.addClass("sidebarnew-left");
        }
    ...
    $(document).on('click', '.sidebarnew .list-group-item', function(){
        $('.sidebarnew .list-group-item').each(function(){
    ...
    $(document).on('click', '.sidebarnew .list-group-item', function(event){
...
//restituisce il lato del sidebarnew in base alla classe che trova settata
    function getSide(listaClassi){
        var side;
        for(var i = 0; i<listaClassi.length; i++){
            if(listaClassi[i]=='sidebarnew-left'){
                side = "left";
                break;
            }else if(listaClassi[i]=='sidebarnew-right'){
                side = "right";
                break;
            }else{
                side = null;
